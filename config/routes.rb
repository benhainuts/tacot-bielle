Rails.application.routes.draw do
  ...
  get "cars/:id/alerts", to: "plan_items#alerts", as: :car_alerts
  ...
  get "cars/:id/call_maintenance", to: "cars#call_maintenance", as: :call_maintenance
  get "cars/:id/details", to: "cars#details", as: :car_details
